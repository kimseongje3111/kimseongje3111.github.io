...
C 클래스 객체인 obj_I1의 데이터 타입을 I1으로 한다는 것은 C 클래스 객체를 외부에서 제어할 수 있는 조작 장치를 I1의 멤버로 제한한다는 의미가 된다.
결과적으로 C 클래스가 인터페이스 I1과 I2를 다중 상속함으로써 하나의 클래스가 다양한 형태를 띠게 되는 것이다.
